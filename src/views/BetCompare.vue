...
function removeUser(data, index) {
    // betCompareUserArray.value = betCompareUserArray.value?.filter((item) => {
    //     return item !== data
    // })
...
// betCompareUserArray.value = JSON.parse(localStorage.getItem('bet_compare_user_array')) == null ? [] : JSON.parse(localStorage.getItem('bet_compare_user_array'))
